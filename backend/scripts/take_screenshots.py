...
async def main():
    ...
    try:
        ...
        async with apw() as pw:
            ...
            await assert_visible(page, "buyer", msg="buyer card")
            await assert_visible(page, "seller", msg="seller card")
            ...
            # ---- 02: Trust Scores ----
            log("--- 02: Trust Scores ---")
            await page.evaluate(f"window.dispatchEvent(new CustomEvent('setSession', {{detail: '{verified_sid}'}}))")
            await page.wait_for_timeout(2000)
            await assert_visible(page, "buyer", timeout=20000)
            await assert_visible(page, "seller")
            await page.screenshot(
            ...
            await page.evaluate(f"window.dispatchEvent(new CustomEvent('setSession', {{detail: '{manip_sid}'}}))")
            await page.wait_for_timeout(2000)
            await assert_visible(page, "violations-panel", timeout=20000)
            ...
            await page.click(f"text={verified_sid}")
            await page.wait_for_timeout(2000)
            await assert_visible(page, "ledger-panel", timeout=20000)
            await page.wait_for_timeout(2000)
            ...
            await page.click(f"text={manip_sid}")
            await page.wait_for_timeout(2000)
            await assert_visible(page, "ledger-panel", timeout=20000)
            await page.wait_for_timeout(2000)
            await page.evaluate("window.scrollTo(0, document.body.scrollHeight)")
