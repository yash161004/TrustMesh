...
function inferSourceFormat(src) {
  if (src.startsWith(DATA_PREFIX)) {
    ...
    const mime2 = src.slice(DATA_PREFIX.length, mimeEnd);
    if (mime2 === "image/svg+xml") return "svg";
    const sub = mime2.split("/")[1];
    return sub || void 0;
  }
  try {
...
}, "D:/TrustMesh/TrustMesh/web-astro/node_modules/astro/components/Image.astro", void 0);
...
}, "D:/TrustMesh/TrustMesh/web-astro/node_modules/astro/components/Picture.astro", void 0);
...
}, "D:/TrustMesh/TrustMesh/web-astro/node_modules/astro/components/Font.astro", void 0);
...
export {
  ...
  generic___js as g,
  parseQuality as p,
  resolveDefaultOutputFormat as r
};
